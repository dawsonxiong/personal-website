...
export const albums: Album[] = [
  {
    ...
    tracks: [
      ...
      { title: "Quiereme", artist: "LATIN MAFIA, Fred again.. & bby", length: "2:55" },
      {
      ...
      { title: "I wish it wasnt", length: "3:46" },
    ],
  },
  {
    title: "Blonde",
    ...
    tracks: [
      ...
      { title: "Pink + White", length: "3:04", favourite: true },
      { title: "Be Yourself", length: "1:26" },
      { title: "Solo", length: "4:17" },
      { title: "Skyline To", length: "3:04" },
      { title: "Self Control", length: "4:09", favourite: true },
      ...
      { title: "White Ferrari", length: "4:08", favourite: true },
      { title: "Seigfried", length: "5:34", favourite: true },
  ...
  },
  {
    ...
    tracks: [
      ...
      { title: "From Time", artist: "Drake & Jhené Aiko", length: "5:22", favourite: true },
      {
      ...
      { title: "Come Thru", length: "3:56" },
      { title: "All Me", artist: "Drake, 2 Chainz & Big Sean", length: "4:31" },
    ],
  },
];
